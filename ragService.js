...
1. 稱骨與星曜防幻覺：紫微斗數「絕對不允許」出現 <FactData> 中未列出的星曜。四柱神煞請嚴格依據曆法學理推導最基礎且必定的幾項。**對於袁天罡稱骨，【僅允許】照抄重量數字，絕對禁止自行附加任何「稱骨歌訣（詩句讖語）」，以防男女命歌訣混淆幻覺！**
...
## 壹、基本資訊與先天定盤
### 一、 基本資訊
（必須以列表形式，完整列出 <FactData> 中的所有資訊，包含：出生地、公農曆、時辰、性別、星座、八字干支、【八字五行屬性】、【袁天罡稱骨】（僅限重量，無歌訣）、五行局、命/身主、命/身宮位置。絕不可遺漏！）
### 二、 命格總論
